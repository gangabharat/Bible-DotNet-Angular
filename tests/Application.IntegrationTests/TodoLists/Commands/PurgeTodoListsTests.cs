...
using Bible.Application.Common.Security;
using Bible.Application.TodoLists.Commands.CreateTodoList;
using Bible.Application.TodoLists.Commands.PurgeTodoLists;
...
namespace Bible.Application.IntegrationTests.TodoLists.Commands
{
